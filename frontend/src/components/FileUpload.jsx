...
const FileUpload = ({ onValidationComplete, onValidationError, onLoading }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!file) {
      onValidationError('Please select a CSV file');
      return;
    }
  ...
  return (
    <div className="rounded-md border bg-white p-4 shadow-sm">
      ...
      <div className="mt-6 rounded-md border bg-gray-50 p-4">
        <h4 className="mb-2 text-sm font-semibold text-gray-800">📋 Expected CSV Format</h4>
        <ul className="list-disc space-y-1 pl-5 text-sm text-gray-700">
          <li><strong>npi_number</strong> - Provider's NPI number</li>
          <li><strong>first_name</strong> - First name</li>
          <li><strong>last_name</strong> - Last name</li>
          <li><strong>Status</strong> - Provider status</li>
          <li><strong>Speciality</strong> - Medical specialty</li>
          <li><strong>License_number</strong> - License number</li>
