...
def validate_via_google(address: str) -> dict:
    """
    Wrapper for real-time Google Maps validation.
    Uses the Google Maps Geocoding API to validate address and phone information.
    Returns normalized provider fields for comparison and confidence scoring.
    """
    import googlemaps
    import os
    ...
    if not api_key:
        print("⚠️  GOOGLE_MAPS_API_KEY not set. Returning fallback data.")
        return {
            "npi": "N/A",
            "name": "N/A",
            "address": address,
    ...
    try:
        ...
        if geocode_result:
            ...
            # Extract latitude & longitude (optional for extra scoring)
            ...
            return {
                ...
                "phone": "N/A",  # You can later integrate Google Places API for phone
                "specialty": "N/A",
